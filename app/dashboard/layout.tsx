...
export default function DashboardLayout({
  ...
  return (
    <>
      <nav className="bg-white border-b border-gray-200 text-black fixed z-30 w-full dark:bg-slate-900 dark:border-slate-700">
          ...
          <main>
            <div className="pt-6 px-4">
              <div className="w-full min-h-[calc(100vh-230px)]">
                <div className="bg-white text-black shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:bg-slate-900">
                  {children}
                </div>
              </div>
            </div>
